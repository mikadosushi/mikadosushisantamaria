...
<?php 
	...
	$centerContent = "<div id='centerTitle'>
					...
					<h2 style='text-align:center;font-size:1.1em;color:#FFFF88;text-decoration:underline'>New! Click For Special Half-Off Rolls!</h2>
					<hr/>
					<a class='galleryImage' href='./images/menu.png' target='_blank'><img class='' style='width:97.2%;border:5px white solid' src='./images/menu.png'/></a>
					<!--<div class='yellowMenu' style='color:black;height:262px;overflow:auto'>
					<ul style='font: normal normal normal  15px \"Comic Sans MS\", Arial, Helvetica, sans-serif;'>
					<li>Paradise Roll</li>
					<li>Green Spider Roll</li>
					<li>T.N.T. Roll</li>
					<li>Albacore Onion Roll</li>
					<li>Cream Cheese Delight Roll</li>
					<li>Spicy Sashimi Salad Roll</li>
					<li>California Ceviche Roll</li>
					<li>Ole! Sushi Roll</li>
					<li>Green Bamboo Roll</li>
					<li>Hungry Roll</li>
					<li>Red Hot Night Roll</li>
					<li>King Spider Roll</li>
					<li>New Washington Roll</li>
					<li>Big Santa Maria Roll</li>
					<li>Tempura CA Roll</li>
					<li>Tempura Spicy Tuna Roll</li>
					<li>Golden Spicy Tuna Roll</li>
					<li>Green Spicy Roll</li>
					<li>Backed Salmon Roll</li>
					<li>Crunch Alabacore Roll</li>
					<li>Big Golden Roll</li>
					<li>Tiger Roll</li>
					<li>Backed Shell Fish Roll</li>
					<li>Spicy Crunch Roll</li>
					<li>Super Gragon Roll</li>
					<li>Vegetable Tempura Roll</li>
					<li>Crunch Tuna Roll</li>
					<li>Mango Salmon Skin Salad Roll</li>
	...
	$scriptContent = "<script type=\"text/javascript\" src=\"scripts/gallery_scripts.js\"></script>";
		...
		switch($_GET["page"]){
			...
			$centerContent = "<div id='menuHolder' style='height:500px;overflow:auto'>
							  <ul>
							  <li><img src=\"./images/menu/Appetizers\"></li>
							  <li></li>
							  <li></li>
							  <li></li>
							  <li></li>
			...
			$scriptContent = "<script type='text/javascript'></script>";
			break;
			case "Restaurant":
