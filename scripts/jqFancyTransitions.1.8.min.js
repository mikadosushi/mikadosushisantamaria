...
$('#'+el.id).append("<img class='ft-"+el.id+"' id='ft-"+el.id+j+"' style='width:"+tstripWidth+"px; height:"+params.height+"px; float: left; position: absolute;'></img>");$("#ft-"+el.id+j).css({'background-position':-stripLeft+'px top','left':stripLeft});stripLeft+=tstripWidth;if(params.position=='bottom')
...
$('.ft-'+el.id).attr('href',links[el.id][imgInc[el.id]]);if(opts[el.id].position=='curtain'){currWidth=$('#ft-'+el.id+itemId).width();$('#ft-'+el.id+itemId).css({/*width:0,*/opacity:0,'':'url('+img[el.id][imgInc[el.id]]+')'}).attr('src',img[el.id][imgInc[el.id]]);$('#ft-'+el.id+itemId).animate({/*width:currWidth,*/opacity:1},1000);}else{$('#ft-'+el.id+itemId).css({height:0,opacity:0,'background-image':'url('+img[el.id][imgInc[el.id]]+')'}).attr('src',img[el.id][imgInc[el.id]]);$('#ft-'+el.id+itemId).animate({height:opts[el.id].height,opacity:1},1000);}
